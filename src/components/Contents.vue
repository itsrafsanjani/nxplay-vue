            ...
            <div class="content__mobile-tabs" id="content__mobile-tabs">
              ...
              <div class="content__mobile-tabs-menu dropdown-menu" aria-labelledby="mobile-tabs">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item"><a class="nav-link active" id="1-tab" data-toggle="tab" href="#tab-1" role="tab"
                  ...
                  <div class="comments">
                    <ul class="comments__list">
                      <li class="comments__item">
                        ...
                        <p class="comments__text">There are many variations of passages of Lorem Ipsum available, but
                      ...
                      <li class="comments__item comments__item--answer">
                        ...
                        <p class="comments__text">Lorem Ipsum is simply dummy text of the printing and typesetting
                      ...
                      <li class="comments__item">
                        ...
                        <p class="comments__text">Many desktop publishing packages and web page editors now use Lorem
